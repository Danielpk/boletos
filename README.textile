...
Atualmente o Plugin tem suporte ao Banco do Brasil e a Caixa.
...
O Plugin tenta localizar as configurações no arquivo boleto_bb.php ou boleto_cef_sigcb.php que ficam dentro da pasta config, se ele não achar na pasta do config ele vai carregar o que está dentro do config do plugin.
